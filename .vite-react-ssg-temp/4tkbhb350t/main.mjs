...
var Helmet$2 = class Helmet extends Component {
  static defaultProps = {
    defer: true,
...
const ReactHelmetAsync = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Helmet: Helmet$2,
  HelmetData,
  HelmetProvider
}, Symbol.toStringTag, { value: "Module" }));
const { Helmet: Helmet$1 } = ReactHelmetAsync;
const SEO = ({
  ...
  return /* @__PURE__ */ jsxs(Helmet$1, { children: [
...
const { Helmet: Helmet2 } = ReactHelmetAsync;
const SchemaOrg = ({ data }) => {
  return /* @__PURE__ */ jsx(Helmet2, { children: /* @__PURE__ */ jsx("script", { type: "application/ld+json", children: JSON.stringify(data) }) });
};
const Home = () => {
